            ...
            {!callDetails ? (
                <MeetingModal isOpen={meetingState === 'isScheduleMeeting'}
                    ...
                    <div className="flex flex-col gap-2.5">
                        ...
                        <ReactDatePicker selected={values.dateTime} onChange={(date) => setValues({ ...values, dateTime: date! })} showTimeSelect timeFormat="HH:mm" timeIntervals={15} dateFormate="MMMM d, yyyy h:mm aa" className="w-full rounded bg-dark-3 p-2 focus:outline-none" />
                    </div>
                </MeetingModal>
            ) : (
                <MeetingModal isOpen={meetingState === 'isScheduleMeeting'}
